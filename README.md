...
**ls -i -l** &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; -> gives the contents of the current directory with inode numbers and the long listing. Concatenated two commands. Order doesn't matter: ls -i -l = ls -l -i. Als, ls -li or ls -il would work for the same.     
